...
void main() {
  ...
  test('Cron no conserva una ruta de limpieza remota masiva', () {
    final source = File('lib/core/screens/cron_screen.dart').readAsStringSync();
    expect(source, isNot(contains('cron-cleanup-conversations')));
    expect(source, isNot(contains('_cleanCronConversations')));
